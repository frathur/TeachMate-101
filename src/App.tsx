  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* <header className="p-4 bg-gray-100 shadow"> */}
        {/* Uncomment the navigation below if needed */}
        {/*
        <nav className="flex justify-center space-x-6">
          <Link to="/" className="text-gray-700 hover:text-black">Landing</Link>
          ...
          <Link to="/newchat" className="text-gray-700 hover:text-black">New Chat</Link>
          <Link to="/yourmaterials" className="text-gray-700 hover:text-black">Your Materials</Link>
          <Link to="/yourstudent" className="text-gray-700 hover:text-black">Your Student</Link>
